...
function extractGroups() {
  ...
  async function getGroupsInfo() {
    ...
    groupElements.forEach(element => {
      ...
      // Evitar duplicatas - CORREÇÃO: usar group_id em vez de id
      ...
      // 🔧 CORREÇÃO PRINCIPAL: Campos corrigidos para compatibilidade com PHP
      groups.push({
        group_id: groupId,              // ✅ CORRIGIDO: era "id"
        name: nameElement.textContent.trim(),
        avatar_url: imageElement ? imageElement.src : '', // ✅ CORRIGIDO: era "image"
        members_count: parseInt(memberCount.replace(/\D/g, '')) || 0, // ✅ CORRIGIDO: era "memberCount" + conversão numérica
        privacy: privacy,
    ...
    console.log('Grupos extraídos:', groups); // Log adicional para debug
